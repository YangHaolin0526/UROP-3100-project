...
from utils.training_arguments import Seq2SeqTrainingArguments
import json
...
def main() -> None:
    ...
    print(dir(args))
    # logger = logging.getLogger(__name__)
    # logger.info(args.evaluate)
    # import pdb;pdb.set_trace()
    print(f"args.evaluate: {args.evaluate}")
    if args.evaluate is None:
        raise ValueError("The 'evaluate' configuration is missing in the configuration file.")
